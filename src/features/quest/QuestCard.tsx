...
import { MoreVertical, Check, Target } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        {editing.id === quest.id ? (
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter") editing.onCommit(quest.id, e.currentTarget.value);
            }}
        ...
        <span
          className={`shrink-0 rounded-full px-2.5 py-1 text-xs font-bold ${
            quest.done ? "bg-[#f0f0f0] text-[#b5b5b5]" : "text-accent-gold bg-[#fff5e9]"
          }`}
        >
          +{quest.points}
        </span>
