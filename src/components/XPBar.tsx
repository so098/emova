  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center gap-1.5">
        <span className="rounded-md bg-[linear-gradient(135deg,var(--brand-logo)_0%,var(--ui-button-primary)_100%)] px-2 py-0.5 text-[0.625rem] font-black tracking-widest text-on-accent shadow-[0_2px_8px_rgba(255,148,55,0.4)]">
          LV.{level}
        </span>
      ...
      <div className="relative h-2.5 w-[13.8125rem] overflow-hidden rounded-full bg-accent-gold-bg">
        <div
